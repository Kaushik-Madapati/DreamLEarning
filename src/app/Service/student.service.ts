...
import {STUDENT_BACKGROUNDS} from './../Interface/mock-student-background'
import {STUDENT_ASSESSMENTS} from './../Interface/mock-student-assessment'
...
export class StudentService {
  ...
  getAllStudents():Observable <IStudent[]> {
    ...
    getAllBackground():Observable <StudentBackground[]> {
      return Observable.of(STUDENT_BACKGROUNDS);
     /* return this.http.get(this.url).map(this.extractData)
      .catch(this.handleErrorObservable); */ 

    }

    getAllAssessment():Observable <StudentAssessment[]> {
      return Observable.of(STUDENT_ASSESSMENTS);
     /* return this.http.get(this.url).map(this.extractData)
      .catch(this.handleErrorObservable); */ 
